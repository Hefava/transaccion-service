...
import com.bootcamp.transaccion_service.transaccion_service.domain.utils.SuministroValidationMessages;
import com.bootcamp.transaccion_service.transaccion_service.domain.utils.TokenHolder;
...
import static com.bootcamp.transaccion_service.transaccion_service.domain.utils.SuministroValidationMessages.AGREGAR_SUMINISTRO_DESCRIPTION;
import static com.bootcamp.transaccion_service.transaccion_service.domain.utils.SuministroValidationMessages.AUTHORIZATION;
...
public class SuministroRestController {
    ...
    public ResponseEntity<Void> agregarSuministro(
        ...
        TokenHolder.setToken(cleanedToken);
